const TicTacToe = (() => {
  ...
  const gameBoard = () => {
    ...
    const getField = (num) =>  document.querySelector(`.gameboard button:nth-child(${num})`);
  ...
  const checkWinner = () => {
    if (counter > 3) {
      if (board[1] !== undefined && (board[1] === board[2] && board[2] === board[3]  ||
                                     board[1] === board[4] && board[4] === board[7]  || 
                                     board[1] === board[5] && board[5] === board[9])  ) {                                   
        endGame(board[1]);
      } else if (board[6] !== undefined && (board[6] === board[5] && board[5] === board[4] ||
                                            board[6] === board[3] && board[6] === board[9])) {
                                            
        endGame(board[6])
      } else if (board[7] !== undefined && (board[7] === board[8] && board[8] === board[9] ||
